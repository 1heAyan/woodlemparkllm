...
ALTER TABLE public.tests ADD COLUMN IF NOT EXISTS teacher_id TEXT DEFAULT NULL;
ALTER TABLE public.tests ADD COLUMN IF NOT EXISTS subject TEXT DEFAULT NULL;
ALTER TABLE public.tests ADD COLUMN IF NOT EXISTS media_url TEXT DEFAULT NULL;
ALTER TABLE public.tests ADD COLUMN IF NOT EXISTS total_marks INT DEFAULT NULL;
